...
#  File parameters
######################################################################################
parser.add_argument('--task', type=str, default='orig', help='Specify datasets.')
...
args.checkpoint_name = "1589413558"
...
def add_result(ss):
    with open(args.eval_result_file, 'a', encoding='utf-8') as f:
        f.write(str(ss) + '\n')
    return
...
def preparation():
    ...
    if args.task == 'yelp':
        ...
        args.data_path = '../../data/orig/processed_files/'
